...
ax.set_title('3D Trajectory: Stuck Particle vs Global Best', fontsize=12)
...
anim = FuncAnimation(fig, update, frames=Xhist.shape[0], interval=anim_interval, blit=False)
anim.save("stuck_particle_vs_gbest_3d.gif", writer="pillow")
plt.close(fig)
print("3D Animation saved as stuck_particle_vs_gbest_3d.gif")
